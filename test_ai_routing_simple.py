#!/usr/bin/env python3
"""
AI Routing Logic Test Script (Simple Version)
Kiểm tra việc phân phối request có tận dụng được AI model không
Không cần matplotlib - chỉ dùng thư viện cơ bản
"""
...
class SimpleAIRoutingTester:
    ...
    def test_server_distribution(self, requests_per_scenario=15):
    ...
    def test_load_balancing_efficiency(self, total_requests=60):
    ...
    def test_ai_vs_random_routing(self, requests_per_test=30):
    ...
    def generate_report(self):
        ...
        lb_results = self.test_load_balancing_efficiency(total_requests=50)
        
        # AI vs Random Comparison
        comparison = self.test_ai_vs_random_routing(requests_per_test=25)
...
def main():
    """Main function"""
    print("🚀 AI Routing Logic Test (Simple Version)")
